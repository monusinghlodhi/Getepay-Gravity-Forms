...
if ( ! defined('ABSPATH') || class_exists('WP_GitHub_Updater_GETEPAY_GF')) {
    return;
}
 ...
 * @package WP_GitHub_Updater_GETEPAY_GF
 ...
 */
class WP_GitHub_Updater_GETEPAY_GF
{
    ...
    public function get_new_version()
    {
        ...
        if ($this->overrule_transients() || ( ! isset($version) || ! $version || '' == $version)) {
            ...
            $version = empty($matches[1]) ? false : $matches[1];
